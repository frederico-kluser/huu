...
- `LEARNINGS.md` — permanent, append-only. One distilled rule per entry. Seeded with the append protocol header (copy from any existing skill).
- `JOURNAL.md` — disposable, episodic. Free-form task notes and transient observations; never auto-promoted. Delete after consolidation.
