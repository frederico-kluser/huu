...
### Implementations
- **real-agent.ts**: uses `@mariozechner/pi-coding-agent`, translates Pi events → `AgentEvent`
- **stub-agent.ts**: fake LLM, sleeps 2-5s, writes `STUB_*.md`, useful for visual tests
