...
export function LogArea({
  ...
  const titleLabel = hasFilter
    ? t('tui.log.title_filtered', { agent: formatAgentLabel(filterAgentId!) })
    : t('tui.log.title_all');
  const titleColor = isActive ? theme.aiAccent : theme.ai;
    ...
    >
      <Box justifyContent="space-between">
        ...
        <Text color="gray" dimColor>
          {t('tui.log.events', { count: filtered.length })}
        </Text>
      </Box>
