...
const setBlockAiGenerateVariable = () => {
    return blockConstructor({
        ...
        generator: function (block: Blockly.Block) {
            ...
            return `\n(async () => {
  const resposta = await chatGPT(${promptVar});
  ${outputVar} = resposta;
})();\n`;
        },
    });
...
export default setBlockAiGenerateVariable;
