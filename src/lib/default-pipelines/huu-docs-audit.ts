...
export function getDefaultPipeline(): Pipeline {
  return {
    ...
    description:
      'Inventories every doc, classifies it via the Diátaxis compass, scores the README, flags stale references and measures inline API-doc coverage. Report-only.',
    maxRetries: 1,
